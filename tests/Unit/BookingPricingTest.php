...
class BookingPricingTest extends TestCase
{
    public static function tierBoundariesProvider(): array
    {
        ...
        return [
            ...
            'ten — second tier' => [100, 10, 30, 300, 700, 20, 40],
            'twenty-two (spec)' => [100, 22, 30, 660, 1540, 8, 40],
            'twenty-nine' => [100, 29, 30, 870, 2030, 1, 40],
            'thirty — premium church tier' => [100, 30, 40, 1200, 1800, 20, 50],
            'thirty-one' => [100, 31, 40, 1240, 1860, 19, 50],
    ...
    public function to_js_keeps_legacy_keys_and_publishes_tiers(): void
    {
        ...
        $this->assertSame([5, 10, 30, 50], array_column($payload['tiers'], 'min'));
