        ...
        <div class="prism-glass prism-glow-border p-6 sm:p-7 space-y-5">
            ...
            <div class="text-center space-y-2">
                <span class="prism-pill prism-pill-neon mx-auto">
                    ...
                    <span data-i18n="auth_register_btn">حساب جديد</span>
                </span>
                <h2 class="prism-headline text-xl">
                    <span data-i18n="auth_register_title"
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-3">
                ...
                <div>
                    <label for="name" class="text-xs mb-1 block text-[color:var(--prism-text-2)]"
                           data-i18n="auth_name">الاسم</label>
