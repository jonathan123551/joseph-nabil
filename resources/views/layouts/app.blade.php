    ...
    (function () {
        ...
        const I18N = {
            ar: {
                ...
                discount_family_phrase: 'تم تطبيق أوفر العيلة',
                ...
                price_progress_zero: 'احجز {n} تذاكر للحصول على {nextLabel} — خصم {pct}%',
                price_progress_partial: 'اقتربت من {nextLabel} — احجز {n} تذاكر إضافية لخصم {pct}%',
                price_progress_qualifies: 'تم تطبيق خصم {pct}% على إجمالي حجزك 🎉',
                price_progress_next_tier: '🎉 تم تطبيق {currentLabel} ({currentPct}%) — احجز {n} تذكرة إضافية للوصول إلى {nextLabel} {nextPct}%',
                price_progress_top_tier: '👑 تم تطبيق أعلى مستوى من {currentLabel} — خصم {pct}%',
                ...
                seat_fast_eyebrow: 'حجز سريع ذكي',
                seat_fast_title: 'اختر حجم المجموعة',
                seat_fast_sub: 'استخدم عرض سريع أو اكتب أي رقم. سنختار المقاعد فورًا بنفس منطق أفضل المقاعد الحالي.',
                seat_offer_family: 'العيلة',
                seat_offer_family_meta: 'عرض العيلة 20%',
                seat_offer_church: 'مجموعة كنيسة',
                seat_offer_church_meta: 'خصم 30%',
                seat_offer_large: 'مجموعة كبيرة',
                seat_offer_large_meta: 'خصم 40%',
                seat_offer_full: 'مجموعة كاملة',
                seat_offer_full_meta: 'أفضل قيمة 50%',
                seat_custom_qty: 'عدد مخصص',
                seat_strategy_best_view: 'أفضل رؤية',
                seat_strategy_together: 'نقعد مع بعض',
                seat_strategy_fastest: 'الأسرع',
                seat_best_value: 'أفضل قيمة',
                seat_fast_unlock: 'زوّد {n} تذاكر لفتح خصم {pct}%',
                seat_fast_unlocked: '{badge} خصم {pct}% مفتوح لـ {count} تذكرة',
                seat_fast_unlock_first: 'احجز 5 تذاكر لفتح عرض العيلة',
                seat_fast_apply: 'اختار أفضل المقاعد لي',
                seat_manual_selection: 'اختيار المقاعد يدويًا',
                seat_fast_note: 'تقدر تعدّل المقاعد يدويًا بعد الاختيار السريع.',
            ...
            en: {
                ...
                price_progress_zero: 'Book {n} tickets to unlock {nextLabel} — {pct}% off',
                price_progress_partial: 'Almost at {nextLabel} — add {n} more for {pct}% off',
                price_progress_qualifies: 'A {pct}% discount has been applied to your booking 🎉',
                price_progress_next_tier: '🎉 {currentLabel} ({currentPct}%) active — add {n} more for {nextLabel} ({nextPct}%)',
                price_progress_top_tier: '👑 You unlocked the top {currentLabel} — {pct}% off',
                ...
                seat_fast_eyebrow: 'Smart fast booking',
                seat_fast_title: 'Pick your group size',
                seat_fast_sub: 'Use an offer shortcut, or enter any number. We will pick seats instantly using the current best-seat logic.',
                seat_offer_family: 'Family',
                seat_offer_family_meta: '20% Family Offer',
                seat_offer_church: 'Church Group',
                seat_offer_church_meta: '30% group discount',
                seat_offer_large: 'Large Group',
                seat_offer_large_meta: '40% premium tier',
                seat_offer_full: 'Full Group',
                seat_offer_full_meta: '50% Best Value',
                seat_custom_qty: 'Custom quantity',
                seat_strategy_best_view: 'Best View',
                seat_strategy_together: 'Keep Us Together',
                seat_strategy_fastest: 'Fastest Available',
                seat_best_value: 'Best Value',
                seat_fast_unlock: 'Add {n} more tickets to unlock {pct}%',
                seat_fast_unlocked: '{badge} {pct}% unlocked for {count} tickets',
                seat_fast_unlock_first: 'Book 5 tickets to unlock the Family Offer',
                seat_fast_apply: 'Pick the best seats for me',
                seat_manual_selection: 'Manual seat selection',
                seat_fast_note: 'You can still edit seats manually after auto-pick.',
