    ...
    (function () {
        ...
        const I18N = {
            ar: {
                ...
                /* ===== bulk-discount offer ===== */
                bulk_discount_eyebrow: 'عرض خاص',
                bulk_discount_title_a: 'احجز',
                bulk_discount_title_b: 'تذاكر أو أكثر واحصل على خصم',
                bulk_discount_sub: 'يُطبَّق الخصم تلقائياً على إجمالي الحجز عند اختيار 5 تذاكر أو أكثر.',
                price_subtotal: 'المجموع',
                price_discount: 'الخصم',
                price_final_total: 'الإجمالي بعد الخصم',
                price_progress_zero: 'احجز {n} تذاكر أو أكثر للحصول على خصم {pct}%',
                price_progress_partial: 'أضف {n} تذاكر إضافية للحصول على خصم {pct}%',
            ...
            en: {
                ...
                /* ===== bulk-discount offer ===== */
                bulk_discount_eyebrow: 'SPECIAL OFFER',
                bulk_discount_title_a: 'Book',
                bulk_discount_title_b: 'or more tickets and get',
                bulk_discount_sub: 'The discount is applied automatically to your booking total when you pick 5 or more tickets.',
                price_subtotal: 'Subtotal',
                price_discount: 'Discount',
                price_final_total: 'Total after discount',
                price_progress_zero: 'Book {n} or more tickets to unlock a {pct}% discount',
                price_progress_partial: 'Add {n} more ticket(s) to unlock a {pct}% discount',
